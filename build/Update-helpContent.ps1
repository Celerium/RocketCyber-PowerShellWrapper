...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "RocketCyber-PowerShellWrapper\docs"
        NO  - "RocketCyber-PowerShellWrapper\RocketCyberAPI\docs"

    Example: "C:\Celerium\Projects\RocketCyber-PowerShellWrapper\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "RocketCyber-PowerShellWrapper\docs"
    Reference:
        Yes - "RocketCyber-PowerShellWrapper\docs\Endpoints.csv"
        NO  - "RocketCyber-PowerShellWrapper\RocketCyberAPI\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\RocketCyber-PowerShellWrapper\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/RocketCyber-PowerShellWrapper"
...
.EXAMPLE
    .\Update-helpContent.ps1
        ...
        -csvFilePath "C:\Celerium\Projects\RocketCyber-PowerShellWrapper\docs\Endpoints.csv"
