...
.PARAMETER csvFilePath
    ...
    Reference:
        Yes - "RocketCyber-PowerShellWrapper\docs\S1-Endpoints-v2.1.csv"
        NO  - "RocketCyber-PowerShellWrapper\RocketCyberAPI\docs\S1-Endpoints-v2.1.csv"

    Example: "C:\Celerium\Projects\RocketCyber-PowerShellWrapper\docs\S1-Endpoints-v2.1.csv"
