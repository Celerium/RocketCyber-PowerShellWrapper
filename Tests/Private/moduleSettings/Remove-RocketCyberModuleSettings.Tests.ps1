...
#Available inside It but NOT Describe or Context
    ...
    AfterAll{
        ...
        Remove-RocketCyberModuleSettings -RocketCyberConfPath $exportPath -WarningAction SilentlyContinue
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('moduleSettings') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "No configuration should throw a warning" {
            Remove-RocketCyberModuleSettings -RocketCyberConfPath $invalidPath -WarningAction SilentlyContinue -WarningVariable moduleSettingsWarning
        ...
        It "Saved configuration should be removed" {
            ...
            [bool](Get-Variable -Name RocketCyber_Base_URI -ErrorAction SilentlyContinue)   | Should -BeTrue
            [bool](Get-Variable -Name RocketCyber_API_Key -ErrorAction SilentlyContinue)    | Should -BeTrue
        }
        ...
        It "Saved configuration & variables should be removed" {
            ...
            Export-RocketCyberModuleSettings -RocketCyberConfPath $exportPath -WarningAction SilentlyContinue
            Remove-RocketCyberModuleSettings -RocketCyberConfPath $exportPath -andVariables

            Test-Path -Path $exportPath | Should -BeFalse
            [bool](Get-Variable -Name RocketCyber_Base_URI -ErrorAction SilentlyContinue)   | Should -BeFalse
            [bool](Get-Variable -Name RocketCyber_API_Key -ErrorAction SilentlyContinue)    | Should -BeFalse
        }
