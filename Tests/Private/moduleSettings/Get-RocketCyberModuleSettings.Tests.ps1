...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('moduleSettings') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "Configuration directory should be hidden" {
            ...
            Export-RocketCyberModuleSettings -RocketCyberConfPath $exportPath -ErrorVariable moduleSettingsError -WarningAction SilentlyContinue
        ...
        It "Configuration file should contain required values" {
            ...
            $configFile = Get-RocketCyberModuleSettings -RocketCyberConfPath $exportPath
                $configFile.Count                       | Should -BeGreaterOrEqual 3
                $configFile.RocketCyber_Base_URI              | Should -Not -BeNullOrEmpty
                $configFile.RocketCyber_JSON_Conversion_Depth | Should -Not -BeNullOrEmpty
                $configFile.RocketCyber_API_Key               | Should -Not -BeNullOrEmpty
        }
